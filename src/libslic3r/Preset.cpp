...
// BEGIN MODS SU: more ironing control
    "ironing_type", "ironing_pattern", "ironing_flow", "ironing_speed", "ironing_spacing", "ironing_angle", "ironing_inset","ironing_angle_force_same_direction","ironing_minimal_surface_factor",
// END MODS SU
